...
CREATE TABLE RaceBetType(
	RaceBetTypeID	UNIQUEIDENTIFIER	PRIMARY KEY,
...
CREATE TABLE Result(
	...
	RaceBetTypeID	UNIQUEIDENTIFIER	FOREIGN KEY REFERENCES RaceBetType(RaceBetTypeID)
	);
...
CREATE TABLE Dividend(
	DividendID	UNIQUEIDENTIFIER	PRIMARY KEY,
	ResultID	UNIQUEIDENTIFIER	FOREIGN KEY REFERENCES Result(ResultID),
	AmountPaid	INT
	);
